...
<div id="block-surfise-content--2" class="block block-system block-system-main-block">
      ...
      <div class="views-element-container"><div class="js-view-dom-id-0ed1ca7ba5459867bb8109e9123a24ab36d7ddc23ae3e7fa5732c7ff92134612">
  ...
  Subscribe to 
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 text-right our_mission">
					<a href="/info" style="text-decoration:none;"><h2>Our Mission</h2></a>
				...
				<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 advertising">
					<a href="/info" style="text-decoration:none;"><h2>Advertising</h2></a>
	...
	</section><div class="views-element-container block block-views block-views-blockhome-top-slider-block-1" id="block-views-block-home-top-slider-block-1">
  
    
      <div><div class="js-view-dom-id-343d916ac74e4934a94e40fca6300ece22ca236080fbd708d1f2436a10b4e525">
...
<div class="views-element-container block block-views block-views-blockhome-top-slider-block-2" id="block-views-block-home-top-slider-block-2">
      ...
      <div><div class="js-view-dom-id-de955d6e39ffbc6584e9459e19626d9cbb96a37c663a5389ed9f64c8b60c7153">
  ...
  <section class="pop_prod_main">
	...
	<div class="content">
		...
		<p><p>sit amet, consectetur adiping elit, sed dosit amet, consecte tur adiping elit, sed do [Pair of 20kg]</p></p>
...
<div class="views-element-container block block-views block-views-blockhome-top-slider-block-3" id="block-views-block-home-top-slider-block-3">
      ...
      <div><div class="js-view-dom-id-f770a641edc8a3ad77784f886b566e221c5dc645c1c1fed496a67bc7934cbfeb">
  	...
  	<section class="our_gal">
		<a href="/imagegallery" style="text-decoration:none;"><h2>Our Gallery</h2></a>
		<div class="home_gal">
															<div>
...
<a href="{{ url('medias') }}"><img src="{{ asset('/images/gal_4_2.jpg') }}" alt=""></a>
	...
	</section><div class="views-element-container block block-views block-views-blockhome-top-slider-block-4" id="block-views-block-home-top-slider-block-4">
  
    
      <div><div class="js-view-dom-id-ce3515e299c2a06d2c0e4e2c8236f65f5edc19de5a72b6c465d9b54597253a70">
	...
	<li class="current_item">
		...
		<p><p>Surfise is consectetur adipisicing elit, sed do eiusmod tempor elit, sed incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation.</p> </p>
