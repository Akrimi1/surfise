                  ...
                  <div class="login_inner">
                     ...
                     <form class="user-login-form" data-drupal-selector="user-login-form" action="/user/login" method="post" id="user-login-form" accept-charset="UTF-8">
                        <div class="js-form-item form-item js-form-type-textfield form-item-name js-form-item-name form-no-label">
                           <input autocorrect="none" autocapitalize="none" spellcheck="false" autofocus="autofocus" class="user_name form-text required" placeholder="Username / Email Address" data-drupal-selector="edit-name" type="text" id="edit-name" name="name" value="" size="60" maxlength="60" required="required" aria-required="true">
                        </div>
                        <div class="js-form-item form-item js-form-type-password form-item-pass js-form-item-pass form-no-label">
                           <input class="pass form-text required" placeholder="Password" data-drupal-selector="edit-pass" type="password" id="edit-pass" name="pass" size="60" maxlength="128" required="required" aria-required="true">
                        </div>
                        <input autocomplete="off" data-drupal-selector="form-v2pqzyrkpzjlvjdoqys-hah92ldd6zl-wgakeummtxg" type="hidden" name="form_build_id" value="form-v2PqzYRKpZjLVJDoQyS_hAH92LDD6zl_WGAKeuMMTXg">
                     ...
                     <p class="bot_text">Forgot your username or password? <a href="/user/login#">Reset Here</a></p>
                     <p class="bot_text">Don’t have an account? <a href="{{ url('register_welcome') }}">Sign Up Here</a></p>
                  </div>
               </section>
            </div>
         </div>
               ...
               <div class="container">
                  <div class="row">
                     <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 foot_links">
                        ...
                        <a href="./registerr.html" class="button">Register Now</a>
                     </div>
