                           ...
                           <div class="product_container">
                              <div class="row">
                                 <div class="col-lg-4 col-md-4 col-sm-6 col-xs-6 prof_desc prod res">
                                    <img src="{{ asset('/images/alter.jpg') }}" alt="" class="top_logo_res col">
                                 </div>
                                 <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12 prof_desc prod res hidden-sm">
                                    <h3>CAP Barbell Cast Iron Hex</h3>
								...
								<div class="row">
                                 ...
                                 <ul class="bot_info last pt-3" style="color:white">
                                    ...
                                    <li class="time">Hours - 11:00 a.m - 8:00 p.m <a href="{{ url('products/product_informations') }}" class="btn btn-profile float-right mr-3">Visit Profile Page</a></li>
                                 </ul>
								</div>
								</div>
